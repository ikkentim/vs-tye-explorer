...
namespace TyeExplorer.Commands
{
	internal sealed class AttachToStartupProjectsCommand : TyeCommand
	{
		...
		public AttachToStartupProjectsCommand(TyeServicesProvider tyeServicesProvider, DebuggerAttacher debuggerAttacher) :
		...
		protected override async Task ExecuteAsync(object sender, EventArgs e)
		{
			...
			if (startupProjects == null) return;
			...
			foreach (string projectPath in startupProjects)
			{
				...
				if (service != null && _tyeServicesProvider.IsAttachableService(service))
