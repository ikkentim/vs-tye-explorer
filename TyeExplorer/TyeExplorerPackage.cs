...
namespace TyeExplorer
{
	...
	[Guid(TyeExplorerPackage.PackageGuidString)]
	...
	public sealed class TyeExplorerPackage : AsyncPackage
	{
		...
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
		    ...
		    await TyeExplorerToolWindowCommand.InitializeAsync(this);
		    await ReloadTyeExplorerCommand.InitializeAsync(this);
		    await TyeExplorer.Commands.OpenTyeDashboardCommand.InitializeAsync(this);
		}
